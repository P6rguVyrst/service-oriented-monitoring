...
Application Monitoring Demo description
...
## Development environment and release process
 ...
 - create virtualenv with Flask and Application Monitoring Demo installed into it (latter is installed in
...
install it (`pip install app_mon.tar.gz`), ensure that configuration file exists and
`APP_MON_SETTINGS` environment variable points to it, ensure that user has access to the
